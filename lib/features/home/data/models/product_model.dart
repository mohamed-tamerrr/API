class ProductFromPost {
  String? title;
  ProductFromPost(this.title);
  factory ProductFromPost.fromJson(dynamic data) {
    return ProductFromPost(data['title']);
  }
}
